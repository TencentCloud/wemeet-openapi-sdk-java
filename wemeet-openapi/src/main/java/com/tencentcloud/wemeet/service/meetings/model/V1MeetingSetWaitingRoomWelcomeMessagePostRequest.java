...
public class V1MeetingSetWaitingRoomWelcomeMessagePostRequest {
     ...
     */
    public V1MeetingSetWaitingRoomWelcomeMessagePostRequest(@NotNull Boolean enableWelcome, @NotNull String meetingId, @NotNull String operatorId, @NotNull BigDecimal operatorIdType, @NotNull String welcomeText) {
     ...
     * @param operatorIdType 操作者 ID 的类型： 1: 企业内用户 userid。 2: open_id (required)
     */
    public V1MeetingSetWaitingRoomWelcomeMessagePostRequest operatorIdType(@NotNull BigDecimal operatorIdType) {
        this.operatorIdType = operatorIdType;
        return this;
    }
    /**
     ...
     * @param operatorIdType 操作者 ID 的类型： 1: 企业内用户 userid。 2: open_id (required)
     */
    public void setOperatorIdType(BigDecimal operatorIdType) {
        this.operatorIdType = operatorIdType;
    }
    /**
     * @param welcomeText 欢迎语，文本类型，最大长度1000字符。欢迎语中如果传入占位符%NICKNAME%（大小写敏感），则该占位符会被替换为被私聊用户的会中昵称。一条消息中支持多个占位符。 (required)
