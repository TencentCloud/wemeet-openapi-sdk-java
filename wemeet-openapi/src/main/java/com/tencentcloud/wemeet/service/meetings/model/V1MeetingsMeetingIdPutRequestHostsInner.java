...
public class V1MeetingsMeetingIdPutRequestHostsInner {
     ...
     */
    public V1MeetingsMeetingIdPutRequestHostsInner(@NotNull String userid) {
        this.userid = userid;
    }
     ...
     */
    public V1MeetingsMeetingIdPutRequestHostsInner isAnonymous(Boolean isAnonymous) {
     ...
     */
    public V1MeetingsMeetingIdPutRequestHostsInner nickName(String nickName) {
     ...
     * @param userid 用户 ID（企业内部请使用企业唯一用户标识；OAuth2.0 鉴权用户请使用 openId）。  企业唯一用户标识说明：  企业对接 SSO 时使用的员工唯一标识 ID，企业调用创建用户接口时传递的 userid 参数。 (required)
     */
    public V1MeetingsMeetingIdPutRequestHostsInner userid(@NotNull String userid) {
        this.userid = userid;
        return this;
    }
    /**
    ...
    public boolean equals(Object o) {
        ...
        V1MeetingsMeetingIdPutRequestHostsInner v1MeetingsMeetingIdPutRequestHostsInner = (V1MeetingsMeetingIdPutRequestHostsInner) o;
        return Objects.equals(this.isAnonymous, v1MeetingsMeetingIdPutRequestHostsInner.isAnonymous) &&
            Objects.equals(this.nickName, v1MeetingsMeetingIdPutRequestHostsInner.nickName) &&
            Objects.equals(this.userid, v1MeetingsMeetingIdPutRequestHostsInner.userid);
    }
    ...
    */
    ...
    public String toString() {
        ...
        sb.append("class V1MeetingsMeetingIdPutRequestHostsInner {\n");
