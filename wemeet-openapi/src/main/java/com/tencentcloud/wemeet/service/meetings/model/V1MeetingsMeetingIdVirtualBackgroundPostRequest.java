...
public class V1MeetingsMeetingIdVirtualBackgroundPostRequest {
    ...
    /**
     * @param image 背景图片 url，尺寸大小为1920*1080，小于10M，jpg/png/jpeg 格式如果不传入则使用会议室默认虚拟背景。 (required)
     ...
     */
    public V1MeetingsMeetingIdVirtualBackgroundPostRequest(@NotNull String image, @NotNull Long instanceid, @NotNull String operatorId, @NotNull Long operatorIdType, @NotNull Long type) {
        this.image = image;
     ...
     * @param image 背景图片 url，尺寸大小为1920*1080，小于10M，jpg/png/jpeg 格式如果不传入则使用会议室默认虚拟背景。 (required)
     */
    public V1MeetingsMeetingIdVirtualBackgroundPostRequest image(@NotNull String image) {
        this.image = image;
        return this;
    }
    /**
    ...
    @Override
    public int hashCode() {
        return Objects.hash(image, instanceid, operatorId, operatorIdType, type);
    }
