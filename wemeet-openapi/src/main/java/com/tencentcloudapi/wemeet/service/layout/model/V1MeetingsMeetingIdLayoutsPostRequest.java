...
public class V1MeetingsMeetingIdLayoutsPostRequest {
     ...
     */
    public V1MeetingsMeetingIdLayoutsPostRequest(@NotNull Long instanceid, @NotNull List<V1MeetingsMeetingIdLayoutsPostRequestLayoutListInner> layoutList, @NotNull String operatorId, @NotNull Long operatorIdType, @NotNull String userid) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(defaultLayoutOrder, instanceid, layoutList, operatorId, operatorIdType, userid);
    }
