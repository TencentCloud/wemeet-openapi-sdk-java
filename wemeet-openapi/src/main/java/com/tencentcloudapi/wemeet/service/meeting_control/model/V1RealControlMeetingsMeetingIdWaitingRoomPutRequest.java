...
public class V1RealControlMeetingsMeetingIdWaitingRoomPutRequest {
     ...
     */
    public V1RealControlMeetingsMeetingIdWaitingRoomPutRequest(@NotNull Long instanceid, @NotNull Long operateType, @NotNull List<V1RealControlMeetingsMeetingIdWaitingRoomPutRequestUsersInner> users) {
     ...
     * @param users 被操作用户对象信息列表 (required)
     */
    public V1RealControlMeetingsMeetingIdWaitingRoomPutRequest users(@NotNull List<V1RealControlMeetingsMeetingIdWaitingRoomPutRequestUsersInner> users) {
        this.users = users;
        return this;
    }
    /**
     ...
     * @param users 被操作用户对象信息列表 (required)
     */
    public void setUsers(List<V1RealControlMeetingsMeetingIdWaitingRoomPutRequestUsersInner> users) {
        this.users = users;
    }
