...
public class V1AppToolkitPostRequest {
     ...
     */
    public V1AppToolkitPostRequest(@NotNull Long instanceid, @NotNull String meetingId, @NotNull String userid) {
    ...
    /**
     * @param toolList 工具箱应用列表
     */
    public V1AppToolkitPostRequest toolList(List<V1AppToolkitPostRequestToolListInner> toolList) {
