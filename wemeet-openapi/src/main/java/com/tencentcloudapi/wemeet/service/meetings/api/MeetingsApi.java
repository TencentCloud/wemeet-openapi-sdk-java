...
public class MeetingsApi {
    ...
    public static class ApiV1MeetingsMeetingIdEnrollApprovalsGetRequest {
        ...
        /**
         * operatorId 操作者 ID。会议创建者可以导入报名信息。 operator_id 必须与 operator_id_type 配合使用。根据 operator_id_type 的值，operator_id 代表不同类型。  operator_id_type&#x3D;2，operator_id必须和公共参数的openid一致。  operator_id和userid至少填写一个，两个参数如果都传了以operator_id为准。  使用OAuth公参鉴权后不能使用userid为入参。 (optional)
         */
        private String operatorId;

        /**
         * operatorIdType 操作者 ID 的类型：  1: userid 2: open_id  如果operator_id和userid具有值，则以operator_id为准； (optional)
         */
        private String operatorIdType;

        /**
         * userid 会议创建者的用户 ID（企业内部请使用企业唯一用户标识；OAuth2.0 鉴权用户请使用 openId）为了防止现网应用报错，此参数实则仍然兼容openid，如无oauth应用使用报名接口则也可做成不兼容变更。 (optional)
         */
        private String userid;
        ...
        public static class Builder {
            ...
            /**
             * @param operatorId 操作者 ID。会议创建者可以导入报名信息。 operator_id 必须与 operator_id_type 配合使用。根据 operator_id_type 的值，operator_id 代表不同类型。  operator_id_type&#x3D;2，operator_id必须和公共参数的openid一致。  operator_id和userid至少填写一个，两个参数如果都传了以operator_id为准。  使用OAuth公参鉴权后不能使用userid为入参。 (optional)
             */
            public Builder operatorId(String operatorId) {
                this.operatorId = operatorId;
                return this;
            ...
            /**
             * @param operatorIdType 操作者 ID 的类型：  1: userid 2: open_id  如果operator_id和userid具有值，则以operator_id为准； (optional)
             */
            public Builder operatorIdType(String operatorIdType) {
                this.operatorIdType = operatorIdType;
                return this;
            ...
            /**
             * @param userid 会议创建者的用户 ID（企业内部请使用企业唯一用户标识；OAuth2.0 鉴权用户请使用 openId）为了防止现网应用报错，此参数实则仍然兼容openid，如无oauth应用使用报名接口则也可做成不兼容变更。 (optional)
             */
            public Builder userid(String userid) {
                this.userid = userid;
                return this;
    ...
    public static class ApiV1MeetingsMeetingIdQosGetRequest {
        ...
        /**
         * subMeetingId 周期性会议子id (required)
         */
        private String subMeetingId;
        ...
        public static class Builder {
            ...
            /**
             * @param subMeetingId 周期性会议子id (required)
             */
            public Builder subMeetingId(String subMeetingId) {
                this.subMeetingId = subMeetingId;
                return this;
    ...
    */
    ...
    public ApiV1MeetingsMeetingIdQosGetResponse v1MeetingsMeetingIdQosGet(ApiV1MeetingsMeetingIdQosGetRequest req, Serializable serializer, AuthenticatorBuilder<?>... builders) throws ClientException, ServiceException {
        try {
            ...
            // verify the required parameter 'subMeetingId' is set
            if (req.getSubMeetingId() == null) {
                throw new IllegalArgumentException("'subMeetingId' is required and must be specified");
            }
