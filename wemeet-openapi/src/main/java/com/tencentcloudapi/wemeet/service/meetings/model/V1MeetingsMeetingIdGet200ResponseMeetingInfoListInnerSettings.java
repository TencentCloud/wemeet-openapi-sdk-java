...
public class V1MeetingsMeetingIdGet200ResponseMeetingInfoListInnerSettings {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(allowInBeforeHost, allowScreenSharedWatermark, allowUnmuteSelf, autoInWaitingRoom, autoRecordType, changeNickname, enableHostPauseAutoRecord, muteEnableJoin, muteEnableTypeJoin, onlyAllowEnterpriseUserJoin, onlyUserJoinType, participantJoinAutoRecord, waterMarkType);
    }
