...
public class V1RealControlMeetingsMeetingIdMutesPutRequestUser {
     ...
     */
    public V1RealControlMeetingsMeetingIdMutesPutRequestUser(@NotNull Long instanceid) {
     ...
     * @param instanceid 用户的终端设备类型： 0：PSTN 1：PC 2：Mac 3：Android 4：iOS 5：Web 6：iPad 7：Android Pad 8：小程序 9：voip、sip 设备 10：linux 20：Rooms for Touch Windows 21：Rooms for Touch MacOS 22：Rooms for Touch Android 30：Controller for Touch Windows 32：Controller for Touch Android 33：Controller for Touch iOS 说明：请与被操作者的设备类型保持一致，否则不生效。 (required)
     */
    public V1RealControlMeetingsMeetingIdMutesPutRequestUser instanceid(@NotNull Long instanceid) {
        this.instanceid = instanceid;
        return this;
    }
    /**
     ...
     */
    public V1RealControlMeetingsMeetingIdMutesPutRequestUser toOperatorId(String toOperatorId) {
     ...
     */
    public V1RealControlMeetingsMeetingIdMutesPutRequestUser toOperatorIdType(Long toOperatorIdType) {
     ...
     */
    public V1RealControlMeetingsMeetingIdMutesPutRequestUser uuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
    /**
    ...
    public boolean equals(Object o) {
        ...
        V1RealControlMeetingsMeetingIdMutesPutRequestUser v1RealControlMeetingsMeetingIdMutesPutRequestUser = (V1RealControlMeetingsMeetingIdMutesPutRequestUser) o;
        return Objects.equals(this.instanceid, v1RealControlMeetingsMeetingIdMutesPutRequestUser.instanceid) &&
            Objects.equals(this.toOperatorId, v1RealControlMeetingsMeetingIdMutesPutRequestUser.toOperatorId) &&
            Objects.equals(this.toOperatorIdType, v1RealControlMeetingsMeetingIdMutesPutRequestUser.toOperatorIdType) &&
            Objects.equals(this.uuid, v1RealControlMeetingsMeetingIdMutesPutRequestUser.uuid);
    }
