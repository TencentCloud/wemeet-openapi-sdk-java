...
public class V1MeetingsPost200ResponseMeetingInfoListInner {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(currentCoHosts, enableLive, endTime, hostKey, hosts, joinUrl, liveConfig, meetingCode, meetingId, participants, password, settings, startTime, subject);
    }
