...
public class V1GuestsMeetingIdPutRequest {
     ...
     */
    public V1GuestsMeetingIdPutRequest(@NotNull List<V1GuestsPutRequestGuestsInner> guests, @NotNull Long instanceid, @NotNull String userid) {
        this.guests = guests;
     ...
     * @param guests  会议嘉宾列表（传空数组会清空嘉宾列表）。 (required)
     */
    public V1GuestsMeetingIdPutRequest guests(@NotNull List<V1GuestsPutRequestGuestsInner> guests) {
        this.guests = guests;
        return this;
    }
    /**
