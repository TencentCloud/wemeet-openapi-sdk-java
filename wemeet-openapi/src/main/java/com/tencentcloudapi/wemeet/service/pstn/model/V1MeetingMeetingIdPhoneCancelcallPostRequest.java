...
public class V1MeetingMeetingIdPhoneCancelcallPostRequest {
     ...
     */
    public V1MeetingMeetingIdPhoneCancelcallPostRequest(@NotNull String operatorId, @NotNull Long operatorIdType) {
    ...
    /**
     * @param phoneNumbers 电话号码对象数组
     */
    public V1MeetingMeetingIdPhoneCancelcallPostRequest phoneNumbers(List<V1MeetingMeetingIdPhoneCancelcallPostRequestPhoneNumbersInner> phoneNumbers) {
