...
public class V1MeetingsMeetingIdEnrollConfigPutRequest {
     ...
     */
    public V1MeetingsMeetingIdEnrollConfigPutRequest(@NotNull Long instanceid) {
     ...
     */
    public V1MeetingsMeetingIdEnrollConfigPutRequest operatorId(String operatorId) {
    ...
    /**
     * @param operatorIdType 操作者 ID 的类型：  1: userid 2: open_id  如果operator_id和userid具有值，则以operator_id为准；
     */
    public V1MeetingsMeetingIdEnrollConfigPutRequest operatorIdType(Long operatorIdType) {
     ...
     * @param userid 用户id
     */
    public V1MeetingsMeetingIdEnrollConfigPutRequest userid(String userid) {
        this.userid = userid;
        return this;
    }
    /**
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.approveType, v1MeetingsMeetingIdEnrollConfigPutRequest.approveType) &&
            ...
            Objects.equals(this.userid, v1MeetingsMeetingIdEnrollConfigPutRequest.userid);
    }

    @Override
    public int hashCode() {
        return Objects.hash(approveType, coverImage, displayNumberOfParticipants, enrollDeadline, enrollDescription, enrollNumber, enrollPushType, instanceid, isCollectQuestion, noRegistrationNeededForStaff, operatorId, operatorIdType, questionList, userid);
    }
