...
public class MeetingRoomApi {
    ...
    public static class ApiV1MeetingRoomsOperatorIdMeetingsGetRequest {
        ...
        /**
         * targetRoomsId 目标查询 roomsid。 (required)
         */
        private String targetRoomsId;

        /**
         * targetRoomsIdType 目标查询 roomsid 的类型： 3：rooms 设备 rooms_id 5：会议室 ID meeting_room_id (required)
         */
        ...
        public static class Builder {
            ...
            /**
             * @param targetRoomsId 目标查询 roomsid。 (required)
             */
            ...
            /**
             * @param targetRoomsIdType 目标查询 roomsid 的类型： 3：rooms 设备 rooms_id 5：会议室 ID meeting_room_id (required)
             */
    ...
    */
    ...
    public ApiV1MeetingRoomsOperatorIdMeetingsGetResponse v1MeetingRoomsOperatorIdMeetingsGet(ApiV1MeetingRoomsOperatorIdMeetingsGetRequest req, Serializable serializer, AuthenticatorBuilder<?>... builders) throws ClientException, ServiceException {
        try {
            ...
            // verify the required parameter 'targetRoomsId' is set
            if (req.getTargetRoomsId() == null) {
                throw new IllegalArgumentException("'targetRoomsId' is required and must be specified");
            }
            

            // verify the required parameter 'targetRoomsIdType' is set
            if (req.getTargetRoomsIdType() == null) {
                throw new IllegalArgumentException("'targetRoomsIdType' is required and must be specified");
            }
