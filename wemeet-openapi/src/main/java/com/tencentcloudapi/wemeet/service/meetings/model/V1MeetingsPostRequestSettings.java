...
public class V1MeetingsPostRequestSettings {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(allowInBeforeHost, allowMultiDevice, allowScreenSharedWatermark, allowUnmuteSelf, autoInWaitingRoom, autoRecordType, changeNickname, enableHostPauseAutoRecord, muteEnableJoin, muteEnableTypeJoin, onlyEnterpriseUserAllowed, onlyUserJoinType, participantJoinAutoRecord, playIvrOnJoin, playIvrOnLeave, waterMarkType);
    }
