...
public class V1UsersPostRequest {
     ...
     */
    public V1UsersPostRequest(@NotNull String phone, @NotNull String userid, @NotNull String username) {
        this.phone = phone;
        this.userid = userid;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(area, autoInvite, email, entryTime, jobTitle, phone, staffId, userAccountType, userid, username);
    }
